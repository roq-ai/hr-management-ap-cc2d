  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to HR Management Application: Your one-stop solution for efficient and streamlined human resource processes. Experience the power of optimized HR operations today."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to HR Management Application: Your one-stop solution for efficient and streamlined human resource processes. Experience the power of optimized HR operations today.`}
            </Text>
            <Box
