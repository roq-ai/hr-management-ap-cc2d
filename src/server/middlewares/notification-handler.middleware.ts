...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Employee Addition.create': { roles: ['owner'], key: 'employee_addition', tenantPath: [], userPath: [] },
  'Task Assignment.create': { roles: ['hr-manager', 'owner'], key: 'task_assignment', tenantPath: [], userPath: [] },
  'Policy Update.update': { roles: ['hr-manager', 'employee'], key: 'policy_update', tenantPath: [], userPath: [] },
};
